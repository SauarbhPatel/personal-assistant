...
__all__ = [
    'SPAR_Low', 'eLEXTYPE_PRIVATE10', 'DISPID_SLPsItem',
    'ISpEventSource', 'ISpProperties', 'SECFIgnoreKanaType',
    'DISPID_SOTCSetId', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SDKGetBinaryValue', '_ISpeechVoiceEvents',
    'SREPhraseStart', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRs_NewEnum', 'DISPID_SAFGetWaveFormatEx', 'SpLexicon',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SWFEFormatTag', 'SpeechDictationTopicSpelling',
    'DISPID_SRCEventInterests', 'SDTPronunciation',
    'SpeechAudioState', 'DISPID_SPIEnginePrivateData', 'SPSFunction',
    'DISPID_SpeechVoiceStatus', 'ISpeechRecoResult',
    'ISpeechRecoResultTimes', 'SREStateChange', 'SVP_2',
    'SAFTCCITT_uLaw_22kHzMono', 'SpVoice',
    'DISPID_SVSInputWordLength', 'SAFT48kHz16BitStereo',
    'SPPS_Modifier', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVP_11', 'SPEI_RESERVED6', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRInitialState', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_21',
    'tagSPPROPERTYINFO', 'DISPID_SVPause', 'SRADefaultToActive',
    'SpeechPropertyHighConfidenceThreshold', 'SPSHT_OTHER',
    'ISpeechPhraseProperties', 'SVSFDefault', 'SPSNoun',
    'SP_VISEME_0', 'SAFT8kHz8BitStereo', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechMemoryStream', 'SGDSInactive',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPRuleId', 'SPGS_ENABLED', 'SpeechStreamFileMode',
    'SDKLCurrentConfig', 'SINoise', 'IStream', 'DISPID_SGRSTsCount',
    'DISPID_SLGenerationId', 'DISPID_SLWs_NewEnum', 'SRAImport',
    'DISPID_SpeechRecoResult2', 'SAFT32kHz16BitStereo',
    'DISPID_SOTCEnumerateTokens', 'STCInprocServer', 'STCAll',
    'DISPID_SVStatus', 'DISPID_SOTRemove', 'SPPROPERTYINFO',
    'DISPID_SRGDictationLoad', 'SSTTWildcard', 'DISPID_SPAPhraseInfo',
    'ISpShortcut', 'SDTAll', 'ISpNotifySink',
    'DISPID_SDKSetLongValue', 'SAFT12kHz8BitStereo',
    'SDKLLocalMachine', 'eLEXTYPE_RESERVED7', 'SPWORDLIST',
    'DISPID_SRCESoundStart', 'DISPID_SRIsUISupported',
    'ISpeechWaveFormatEx', 'DISPID_SRCPause', 'SVSFVoiceMask',
    'DISPID_SGRSTPropertyName', 'DISPID_SPCPhoneToId',
    'SAFTADPCM_11kHzStereo', 'DISPID_SGRSRule',
    'DISPID_SpeechAudioFormat',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eWORDTYPE_ADDED', 'SVEEndInputStream', 'SP_VISEME_6',
    'DISPIDSPTSI_SelectionLength',
    'SpeechGrammarTagUnlimitedDictation', 'SRESoundEnd',
    'SAFTCCITT_ALaw_8kHzMono', 'SPSMF_SAPI_PROPERTIES',
    'SDTReplacement', 'DISPID_SDKEnumKeys', 'SP_VISEME_13',
    'DISPID_SVEStreamEnd', 'DISPID_SPIGetText', 'ISpeechGrammarRules',
    'DISPID_SPPFirstElement', 'ISpeechResourceLoader', 'SREAllEvents',
    'SPDKL_CurrentUser', 'SAFT8kHz16BitStereo', 'SPSHT_EMAIL',
    'DISPID_SpeechPhraseAlternate', 'SP_VISEME_16', 'SLOStatic',
    'SpTextSelectionInformation', 'DISPID_SpeechLexiconWord',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTGSM610_44kHzMono',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_PRIVATE7',
    'SpResourceManager', 'SRSInactive',
    'DISPID_SRSCurrentStreamNumber', 'SPAS_RUN',
    'DISPID_SRRTStreamTime', 'SpeechRetainedAudioOptions',
    'SPPHRASEPROPERTY', 'SpeechVoiceEvents',
    'DISPID_SVEEnginePrivate', 'SpeechPropertyResourceUsage',
    'eLEXTYPE_PRIVATE13', 'ISpeechCustomStream', 'DISPID_SOTId',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_RESERVED8', 'DISPID_SGRsAdd', 'SVP_15',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCEAudioLevel', 'SVP_19',
    'SGRSTTWildcard', 'ISpRecognizer2', 'SpSharedRecoContext',
    'SVPOver', 'SITooQuiet', 'SpShortcut', 'SPEVENT',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoResultTimes', 'SPSInterjection',
    'ISpPhoneConverter', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRAudioInputStream', 'DISPID_SASCurrentSeekPosition',
    'SpeechCategoryPhoneConverters', 'SAFT44kHz16BitMono',
    'DISPID_SRSSupportedLanguages', 'DISPID_SOTsItem',
    'DISPID_SpeechRecognizerStatus', 'SP_VISEME_9',
    'SAFT44kHz8BitStereo', 'SITooLoud', 'SPBO_NONE',
    'ISpObjectWithToken', 'SGDSActiveWithAutoPause', 'SP_VISEME_2',
    'DISPID_SVEStreamStart', 'DISPID_SGRSTNextState',
    'DISPID_SGRSTransitions', 'SAFTText', 'SpeechRegistryUserRoot',
    'DISPIDSPTSI_ActiveLength', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechXMLRecoResult', 'SPVPRI_NORMAL',
    'DISPID_SPRNumberOfElements', 'DISPID_SRGCmdLoadFromResource',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVEWord', 'DISPID_SGRsCommit', 'DISPID_SRGRecoContext',
    'ISpeechGrammarRuleStateTransition', 'SpeechRunState',
    'DISPID_SDKGetlongValue', 'SPADAPTATIONRELEVANCE',
    'SpInProcRecoContext', 'SPFM_OPEN_READWRITE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpPhraseInfoBuilder',
    'SVEPhoneme', 'ISpVoice', 'SpeechStreamSeekPositionType',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRAORetainAudio',
    'DISPID_SPRuleFirstElement', 'SpeechEngineProperties',
    'SDA_One_Trailing_Space', 'SGRSTTDictation',
    'Speech_Max_Pron_Length', 'DISPID_SABufferNotifySize',
    'ISpRecoResult', 'SGLexical', 'SDTProperty', 'DISPID_SAFGuid',
    'DISPID_SVAudioOutput', 'DISPID_SRIsShared', 'SVEWordBoundary',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRRecoContext',
    'DISPID_SRCreateRecoContext', 'DISPID_SRCEHypothesis',
    'DISPID_SAEventHandle', 'DISPID_SWFEChannels',
    'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechLexiconPronunciation', 'SpeechWordPronounceable',
    'SAFT16kHz16BitStereo', 'SPDKL_CurrentConfig',
    'SAFT12kHz16BitMono', 'SAFT22kHz8BitStereo', '_SPAUDIOSTATE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCEEndStream',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRsDynamic', 'DISPID_SOTDisplayUI',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SAVolume',
    'DISPIDSPTSI', 'DISPID_SLWType', 'DISPID_SPEDisplayAttributes',
    'ISpRecognizer3', 'SVSFIsNotXML', 'SPWT_PRONUNCIATION',
    'SPLO_STATIC', 'SPRST_INACTIVE', 'ISpeechRecoContext',
    'SPPS_Interjection', 'SAFTADPCM_22kHzStereo',
    'IInternetSecurityMgrSite', 'SPRULE', 'ISpRecoContext',
    'SPEVENTSOURCEINFO', 'SVSFParseAutodetect', 'SINoSignal',
    'DISPID_SOTSetId', 'SpeechGrammarState', 'ISpNotifySource',
    'STCInprocHandler', 'DISPID_SGRSTsItem', 'ISpeechRecoGrammar',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT48kHz8BitStereo',
    'SAFT44kHz8BitMono', 'SPAO_RETAIN_AUDIO', 'SVF_None',
    'SpFileStream', 'SDTAudio', 'SREInterference', 'SPEI_SOUND_END',
    'DISPID_SPELexicalForm', 'ISpeechPhraseRules',
    'SAFT32kHz8BitMono', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGDictationSetState', 'DISPID_SGRsFindRule',
    'SpCustomStream', 'SAFT48kHz8BitMono',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCCreateGrammar',
    'SRTReSent', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEAdaptation',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVEPhoneme',
    'ISpStreamFormatConverter', 'SPPHRASE', 'DISPID_SpeechRecoResult',
    'SGPronounciation', 'DISPID_SpeechGrammarRules', 'SVP_0',
    'DISPID_SPRuleEngineConfidence', 'SPFILEMODE', 'SpeechVisemeType',
    'DISPID_SDKEnumValues', 'SpeechGrammarRuleStateTransitionType',
    'SPEI_SR_BOOKMARK', 'ISpObjectTokenCategory', 'DISPID_SOTCId',
    'SPGS_EXCLUSIVE', 'DISPID_SPEAudioTimeOffset', 'SpeechLoadOption',
    'SRTEmulated', 'SPSMF_UPS', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRRGetXMLErrorInfo',
    'SWTAdded', 'SPEI_ADAPTATION', 'SVP_8', 'SpObjectToken',
    'SpUnCompressedLexicon', 'SECLowConfidence', 'DISPID_SGRName',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechAudioFormat',
    'eLEXTYPE_PRIVATE17', 'eLEXTYPE_PRIVATE5', 'DISPID_SpeechAudio',
    'DISPID_SRCEPhraseStart', 'ISpeechObjectTokenCategory',
    'DISPID_SRRTLength', 'SpCompressedLexicon', 'SVP_10', 'SVPNormal',
    'SRSInactiveWithPurge', 'SVP_7', 'SPWF_INPUT', 'SpWaveFormatEx',
    'SBOPause', 'SECHighConfidence', 'SAFT22kHz8BitMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRSClsidEngine', 'DISPID_SPPId',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpDataKey',
    'SWPUnknownWordPronounceable', 'DISPID_SPERequiredConfidence',
    'eLEXTYPE_PRIVATE18', 'ISpeechPhraseAlternate',
    'SpStreamFormatConverter', 'DISPID_SPIElements',
    'DISPID_SPIGetDisplayAttributes', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRCEInterference', 'ISpeechPhraseInfo',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT24kHz8BitStereo',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSpeak',
    'DISPID_SVResume', 'DISPID_SVSLastBookmark', 'SPCS_DISABLED',
    'SPCONTEXTSTATE', 'DISPID_SDKDeleteKey', 'DISPID_SRRSaveToMemory',
    'DISPID_SPRuleConfidence', 'DISPID_SVGetVoices', 'SVP_12',
    'DISPIDSPTSI_ActiveOffset', 'SWTDeleted', 'SECNormalConfidence',
    'SpeechCategoryAudioOut', 'SpeechVisemeFeature',
    'DISPID_SRCBookmark', 'SREPrivate', 'SRARoot',
    'eLEXTYPE_PRIVATE14', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPEAudioStreamOffset',
    'ISpStreamFormat', 'SpeechCategoryVoices', 'SRAExport',
    'DISPID_SRGIsPronounceable', 'ISpeechGrammarRuleState',
    'SVPAlert', 'SRAInterpreter', 'SP_VISEME_14',
    'DISPID_SOTs_NewEnum', 'SPEI_INTERFERENCE', 'DISPID_SVEBookmark',
    'DISPID_SRCRecognizer', 'SRCS_Enabled', 'DISPID_SGRAddState',
    'SAFT16kHz8BitStereo', 'SGRSTTWord',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpInprocRecognizer',
    'DISPID_SAStatus', 'SRSActive', 'eWORDTYPE_DELETED',
    'DISPID_SGRSTPropertyId', 'DISPID_SVIsUISupported',
    'SVF_Emphasis', 'STSF_CommonAppData', 'SPRECOGNIZERSTATUS',
    'DISPID_SPAsItem', 'DISPID_SRCVoice',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_LETTERTOSOUND', 'SPWT_DISPLAY', 'DISPID_SRGState',
    'DISPID_SAFType', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SRSActiveAlways', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFT12kHz16BitStereo', 'DISPID_SRGDictationUnload',
    'DISPID_SVEVoiceChange', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechCategoryAudioIn',
    'SPEI_START_SR_STREAM', 'SDTLexicalForm', 'ISpeechRecognizer',
    'DISPID_SpeechDataKey', 'SVF_Stressed', 'SPAS_PAUSE',
    'IEnumString', 'SRATopLevel', 'SPINTERFERENCE_TOOQUIET',
    'ISpSerializeState', 'SGDSActiveUserDelimited', 'SRTAutopause',
    'ISpeechBaseStream', 'SPSERIALIZEDRESULT',
    'ISpeechTextSelectionInformation', 'DISPID_SRCSetAdaptationData',
    'ISpRecoCategory', 'SPAS_STOP', 'eLEXTYPE_PRIVATE11',
    'SAFTNoAssignedFormat', 'Speech_Max_Word_Length',
    'DISPID_SVSVisemeId', '__MIDL_IWinTypes_0009',
    'DISPID_SMSADeviceId', 'DISPID_SABIEventBias', 'SPVPRIORITY',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechLexicon',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SFSOpen',
    'SPINTERFERENCE_NOISE', 'DISPID_SPIRule', 'SPTEXTSELECTIONINFO',
    'SPEI_MAX_TTS', 'SPEI_FALSE_RECOGNITION', 'SAFTDefault',
    'DISPID_SpeechRecoContextEvents',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SLPLangId',
    'SPSEMANTICFORMAT', 'SPVPRI_ALERT', 'SPFM_OPEN_READONLY',
    'DISPID_SWFEExtraData', 'ISpeechPhraseProperty',
    'DISPID_SRDisplayUI', 'SGLexicalNoSpecialChars',
    'ISpeechRecoResultDispatch', 'SPEI_RECO_STATE_CHANGE',
    'SpeechCategoryAppLexicons',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVRate',
    'DISPID_SDKCreateKey', 'DISPID_SPIAudioSizeTime', 'SPCS_ENABLED',
    'DISPID_SVSInputWordPosition', 'SPAR_Medium',
    'SAFT22kHz16BitMono', 'SVP_16', 'SVSFUnusedFlags',
    'SDA_Two_Trailing_Spaces', 'DISPID_SVEventInterests',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRCESoundEnd', 'DISPID_SPIAudioStreamPosition',
    'SpeechTokenKeyAttributes', 'SpeechPartOfSpeech',
    'SpeechAddRemoveWord', 'DISPID_SPEAudioSizeBytes',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPWAVEFORMATTYPE', 'SPAUDIOSTATUS',
    'SVSFNLPSpeakPunc', 'SPEI_SR_AUDIO_LEVEL', 'SPPS_Verb',
    'SP_VISEME_12', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTADPCM_22kHzMono', 'STSF_FlagCreate',
    'DISPID_SRCVoicePurgeEvent', 'SVP_18', 'ISpeechPhraseInfoBuilder',
    'SpMemoryStream', 'SPEI_TTS_PRIVATE', 'DISPID_SGRSTType',
    'DISPID_SBSWrite', 'SVP_13', 'SPAUDIOBUFFERINFO', 'SRTStandard',
    'SAFT16kHz16BitMono', 'DISPID_SVGetProfiles', 'SVP_4',
    'SDTAlternates', 'DISPID_SVSLastStreamNumberQueued', 'DISPIDSPRG',
    'SPCT_SUB_COMMAND', 'SPINTERFERENCE', 'SRSEDone',
    'DISPID_SLGetGenerationChange', 'DISPID_SBSFormat',
    'eLEXTYPE_MORPHOLOGY', 'SVEViseme', 'SPEI_SR_RETAINEDAUDIO',
    'SP_VISEME_11', 'SRERecoOtherContext', 'SVSFParseSapi',
    'DISPID_SRRTOffsetFromStart', 'SPRST_NUM_STATES',
    'DISPID_SPRuleChildren', 'SPAO_NONE', 'DISPID_SLPsCount',
    'SSFMCreate', 'SpeechVoiceSpeakFlags', 'DISPID_SRRTTickCount',
    'DISPID_SPISaveToMemory', 'eLEXTYPE_USER', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPACommit', 'DISPID_SVSRunningState',
    'DISPID_SPIGrammarId', 'DISPID_SpeechObjectTokens',
    'DISPID_SLWsCount', 'DISPID_SMSSetData', 'SSTTDictation',
    'DISPID_SCSBaseStream', 'SPPS_Noun', '_RemotableHandle',
    'SpeechPropertyAdaptationOn', 'SpeechAudioFormatType',
    '_ISpeechRecoContextEvents', 'SASStop', 'SPEI_VISEME',
    'SPEVENTENUM', 'SPXMLRESULTOPTIONS', 'SGSDisabled',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SASFreeBufferSpace',
    'SPEI_END_SR_STREAM', 'ISpeechVoiceStatus', 'SRERecognition',
    'SVSFPurgeBeforeSpeak', 'SPBINARYGRAMMAR', 'SpNotifyTranslator',
    'DISPID_SPRuleName', 'SSSPTRelativeToEnd', 'SP_VISEME_8',
    'SAFT11kHz16BitMono', 'DISPID_SDKSetStringValue',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SOTsCount',
    'Speech_StreamPos_RealTime', 'SPGRAMMARWORDTYPE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_8kHzMono',
    'SWPUnknownWordUnpronounceable', 'DISPIDSPTSI_SelectionOffset',
    'SP_VISEME_19', 'tagSPTEXTSELECTIONINFO',
    'SAFTExtendedAudioFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'SGDSActive', 'SGRSTTRule', 'DISPID_SRCEBookmark', 'ISpAudio',
    'SSFMOpenReadWrite', 'SAFT48kHz16BitMono', 'SPAS_CLOSED',
    'DISPID_SRGetRecognizers', 'ISequentialStream', 'SITooSlow',
    'SpeechTokenValueCLSID', 'SASPause', 'SVEAllEvents',
    'STSF_LocalAppData', 'SPSModifier',
    'ISpPhoneticAlphabetConverter', 'SPEI_RESERVED2',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechFileStream', 'DISPID_SRRAudioFormat',
    'DISPID_SGRId', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRCERequestUI', 'DISPID_SDKSetBinaryValue',
    'SpAudioFormat', 'DISPID_SGRSAddSpecialTransition',
    'SpeechVoicePriority', 'ISpLexicon', 'DISPID_SPCIdToPhone',
    'SP_VISEME_15', 'SPSHT_NotOverriden', 'SPPS_RESERVED1',
    'DISPID_SpeechPhoneConverter', 'SSSPTRelativeToCurrentPosition',
    'SASClosed', 'ISpeechDataKey', 'SAFT32kHz8BitStereo',
    'SVSFParseMask', 'SP_VISEME_21', 'DISPID_SLGetPronunciations',
    'DISPID_SVDisplayUI', 'ISpeechPhraseElements', 'DISPID_SLWWord',
    'WAVEFORMATEX', 'DISPID_SPPEngineConfidence',
    'DISPID_SPIReplacements', 'DISPID_SPAStartElementInResult',
    'SPLEXICONTYPE', 'DISPID_SMSGetData', 'ISpMMSysAudio',
    'SpeechVoiceCategoryTTSRate', 'ISpObjectToken',
    'eLEXTYPE_PRIVATE19', 'SP_VISEME_3',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechTokenKeyFiles', 'SPRST_ACTIVE_ALWAYS',
    'SRTExtendableParse', 'SPPS_RESERVED4', 'SAFTADPCM_11kHzMono',
    'DISPID_SDKDeleteValue', 'SVSFPersistXML', 'SINone', 'SPSVerb',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_RESERVED6',
    'ISpNotifyTranslator', 'SPINTERFERENCE_NONE',
    'SSSPTRelativeToStart', 'SPVOICESTATUS',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_RESERVED9',
    'DISPID_SPIEngineId', 'SpNullPhoneConverter', 'DISPID_SPPsItem',
    'SPWF_SRENGINE', 'DISPID_SRSCurrentStreamPosition',
    'SAFT16kHz8BitMono', 'ISpeechRecoResult2', 'DISPID_SDKOpenKey',
    'SPEI_TTS_BOOKMARK', 'DISPID_SOTCGetDataKey',
    'DISPID_SVSLastBookmarkId', 'SpeechRuleAttributes',
    'DISPID_SPEs_NewEnum', 'DISPID_SGRAttributes', 'SPEI_RESERVED3',
    'SVP_17', 'SREHypothesis', 'DISPID_SRGetFormat',
    'DISPID_SLRemovePronunciation', 'SVSFNLPMask',
    'DISPID_SPILanguageId', 'SAFT11kHz16BitStereo',
    'SWPKnownWordPronounceable', 'SPPHRASEELEMENT',
    'SpeechDiscardType', 'ISpeechGrammarRule', 'SVP_6',
    'SPEI_PHONEME', 'SPWORDPRONUNCIATION', 'DISPID_SRGRules',
    'SpeechVoiceSkipTypeSentence', 'SPEI_TTS_AUDIO_LEVEL',
    ...
    'Speech_StreamPos_Asap', 'SPSHORTCUTTYPE', 'SPRECORESULTTIMES',
    'SGRSTTTextBuffer', 'DISPID_SGRs_NewEnum',
    'SpeechDisplayAttributes', 'SPINTERFERENCE_TOOFAST',
    'SPEI_REQUEST_UI', 'DISPID_SDKGetStringValue', 'SBONone',
    'ISpeechPhoneConverter', 'STCLocalServer', 'ISpEventSink',
    'SVSFParseSsml', 'DISPID_SPRsItem', 'ISpStream',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SOTGetDescription',
    'SpeechUserTraining', 'SpeechRuleState', 'SPWORD',
    'eLEXTYPE_PRIVATE15', 'SPPS_Function', 'DISPID_SPIStartTime',
    'ISpGrammarBuilder', 'DISPID_SOTCategory', 'SPEI_MAX_SR',
    'SAFTGSM610_8kHzMono', 'DISPID_SPEsItem', 'SSFMCreateForWrite',
    'DISPID_SPPChildren', 'DISPID_SPANumberOfElementsInResult',
    'eLEXTYPE_PRIVATE4', 'SPSLMA', 'SpPhoneConverter',
    'SPEI_UNDEFINED', 'SPFM_NUM_MODES', 'DISPID_SpeechPhraseElement',
    'DISPID_SADefaultFormat', 'SpMMAudioOut', 'DISPID_SPPConfidence',
    'SRESoundStart', 'ISpRecoContext2', 'SpMMAudioEnum',
    'SpeechFormatType', 'DISPID_SPERetainedStreamOffset',
    'SpeechMicTraining', 'DISPID_SpeechMMSysAudio', 'SPLOADOPTIONS',
    'SREAudioLevel', 'SpeechRecoProfileProperties',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRState',
    'DISPID_SpeechLexicon', 'DISPID_SRAudioInput',
    'SpeechTokenContext', 'DISPID_SVSpeakCompleteEvent',
    'SP_VISEME_1', 'SAFT8kHz8BitMono', 'DISPID_SPPNumberOfElements',
    'SPWORDPRONOUNCEABLE', 'SPSERIALIZEDPHRASE', 'ISpeechAudio',
    'ISpXMLRecoResult', 'SDA_No_Trailing_Space', 'SASRun',
    'SREBookmark', 'SPPARTOFSPEECH',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechPhraseReplacement', 'SpObjectTokenCategory',
    'SITooFast', 'ISpeechMemoryStream', 'SRSEIsSpeaking',
    'SpeechRegistryLocalMachineRoot', 'SPCT_COMMAND', 'SRTSMLTimeout',
    'SVSFIsFilename', 'SDKLDefaultLocation', 'SP_VISEME_17',
    'SpeechGrammarWordType', 'SRERequestUI', 'SPBO_TIME_UNITS',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVEViseme', 'SPVPRI_OVER',
    'UINT_PTR', 'ISpeechAudioStatus', 'DISPID_SRRAudio', 'SVP_1',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_PRIVATE12',
    'DISPID_SPRulesItem', 'DISPID_SRRSetTextFeedback', 'SPRECOSTATE',
    'SPCT_SLEEP', 'SECFIgnoreWidth', 'DISPID_SLPSymbolic',
    'SSFMOpenForRead', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRAddResource', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPRules_NewEnum', 'DISPID_SOTGetStorageFileName',
    'SpeechTokenKeyUI', 'SPRS_ACTIVE', 'SPPS_RESERVED3',
    'SpSharedRecognizer', 'DISPID_SOTIsUISupported',
    'DISPID_SGRSTs_NewEnum', 'SAFT11kHz8BitMono',
    'DISPID_SpeechObjectToken', 'SAFTGSM610_22kHzMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechMMSysAudio',
    'SPPS_SuppressWord', 'DISPID_SPPName', 'SVP_5',
    'DISPID_SpeechVoiceEvent', 'SPDATAKEYLOCATION', 'SPSHORTCUTPAIR',
    'ISpeechPhraseRule', 'ISpResourceManager', 'DISPID_SVVoice',
    'SVEVoiceChange', 'SpeechAllElements',
    'DISPID_SRGCmdSetRuleState', 'ISpPhrase', 'DISPID_SPRsCount',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRRecognizer',
    'DISPID_SpeechPhraseRules', 'ISpRecoGrammar2', 'SPRS_INACTIVE',
    'SpeechLexiconType', 'DISPID_SGRSTRule', 'SPSHT_Unknown',
    'DISPID_SRRPhraseInfo', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRGCmdLoadFromMemory', 'SREStreamStart',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFTGSM610_11kHzMono',
    'DISPID_SWFEBlockAlign', 'SREAdaptation', 'SVSFlagsAsync',
    'DISPID_SPRText', 'DISPID_SVPriority', 'SPVISEMES',
    'DISPID_SPPsCount', 'SECFNoSpecialChars', 'SPPS_Unknown',
    'SPEI_SOUND_START', 'SPXRO_Alternates_SML', 'SPEI_RESERVED5',
    'DISPID_SVAlertBoundary', 'DISPID_SVAudioOutputStream',
    'SAFT24kHz8BitMono', 'DISPID_SRGetPropertyString',
    'SpeechGrammarTagWildcard', 'ISpeechPhraseReplacements',
    'ISpeechPhraseElement', 'DISPID_SLPType',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRGId', 'SP_VISEME_4',
    'DISPID_SGRSTWeight', 'DISPID_SGRsCount',
    'DISPID_SpeechBaseStream', 'SPWT_LEXICAL', 'DISPID_SLPPhoneIds',
    'SVEAudioLevel', 'DISPID_SRGSetTextSelection', 'SREStreamEnd',
    'DISPID_SRCEStartStream', 'DISPID_SRCResume',
    'SAFTADPCM_8kHzMono', 'DISPID_SLAddPronunciation',
    'DISPID_SRRGetXMLResult', 'DISPID_SLGetWords', 'DISPID_SFSClose',
    'DISPID_SPRuleParent', 'DISPID_SpeechVoice', 'SPLO_DYNAMIC',
    'SAFTCCITT_ALaw_22kHzMono', 'SPPHRASERULE', 'SECFDefault',
    'SREPropertyNumChange', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechLexiconPronunciation', 'SAFT24kHz16BitStereo',
    'DISPID_SGRsCommitAndSave', 'DISPID_SRSetPropertyString',
    'SP_VISEME_7', 'SpeechDataKeyLocation', 'DISPID_SRStatus',
    'SPCATEGORYTYPE', 'SVESentenceBoundary',
    'SpeechTokenIdUserLexicon', 'SpeechRecognizerState',
    'DISPID_SVGetAudioInputs', 'SPSNotOverriden', 'SP_VISEME_18',
    'SPSEMANTICERRORINFO', 'ISpeechLexiconWord', 'DISPID_SVVolume',
    'ISpeechObjectTokens', 'DISPID_SPRDisplayAttributes',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVSInputSentenceLength',
    'DISPID_SASetState', 'SpeechAudioVolume',
    'DISPID_SABIMinNotification', 'DISPID_SVGetAudioOutputs',
    'SpStream', 'SPEI_RESERVED1', 'STCRemoteServer',
    'SpeechPropertyLowConfidenceThreshold', 'ISpPhraseAlt',
    'SAFT12kHz8BitMono', 'SPBO_AHEAD', 'SpeechAudioProperties',
    'DISPID_SOTMatchesAttributes', 'SPDKL_LocalMachine',
    'DISPID_SVSCurrentStreamNumber', 'Speech_Default_Weight',
    'SPEI_VOICE_CHANGE', 'SPDKL_DefaultLocation', 'SDKLCurrentUser',
    'SPGS_DISABLED', 'SPEI_MIN_TTS', 'SPEI_PHRASE_START',
    'DISPID_SpeechPhraseInfo', 'DISPID_SABufferInfo',
    'DISPID_SPEsCount', 'SVSFIsXML',
    'SpeechPropertyNormalConfidenceThreshold', 'SPRECOCONTEXTSTATUS',
    'ISpeechPhraseReplacement', 'DISPID_SVSkip',
    'DISPID_SPIAudioSizeBytes', 'SFTInput', 'DISPID_SOTGetAttribute',
    'SPAR_Unknown', 'eLEXTYPE_PRIVATE8', 'eLEXTYPE_RESERVED4',
    'DISPID_SASState', 'ISpeechGrammarRuleStateTransitions',
    'ISpeechLexiconWords', 'DISPID_SLWsItem',
    'DISPID_SpeechGrammarRule', 'SPAR_High', 'SPSUnknown',
    'eLEXTYPE_PRIVATE20', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTCDefault',
    'DISPID_SpeechLexiconWords', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPXRO_SML', 'SpeechAudioFormatGUIDWave', 'SpeechBookmarkOptions',
    'SRADynamic', 'DISPID_SRCState', 'SRCS_Disabled', 'SP_VISEME_10',
    'DISPID_SGRClear', 'STSF_AppData', 'SPEI_START_INPUT_STREAM',
    'SVEPrivate', 'DISPID_SPEAudioSizeTime',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SVWaitUntilDone',
    'DISPID_SPEActualConfidence', 'SLTApp', 'SGDisplay',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCEEnginePrivate',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechCategoryRecoProfiles', 'SVEStartInputStream',
    'SPEI_SR_PRIVATE', 'SPEI_RECOGNITION', 'SPRST_ACTIVE',
    'ISpeechVoice', 'SPPS_RESERVED2', 'SPGRAMMARSTATE', 'SPBO_PAUSE',
    'DISPID_SRCAudioInInterferenceStatus', 'SSTTTextBuffer',
    'DISPID_SBSSeek', 'DISPID_SRCEFalseRecognition', 'SLTUser',
    'ISpRecoGrammar', 'SDTDisplayText', 'SPRULESTATE',
    'SAFTADPCM_44kHzMono', 'SFTSREngine', 'DISPID_SPARecoResult',
    'eLEXTYPE_RESERVED10', 'DISPID_SREmulateRecognition',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCERecognition',
    'SAFT44kHz16BitStereo', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPEPronunciation',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRProfile', 'DISPID_SRSAudioStatus',
    'DISPID_SPAs_NewEnum', 'SGRSTTEpsilon', 'ISpeechRecognizerStatus',
    'DISPID_SRRAlternates', 'SGSEnabled',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPAsCount',
    'IInternetSecurityManager', 'DISPID_SPRFirstElement',
    'SPSSuppressWord', 'DISPID_SRGReset', 'DISPID_SABIBufferSize',
    'SpeechPropertyResponseSpeed', 'DISPID_SLWLangId', 'SLODynamic',
    'SpeechCategoryRecognizers', 'DISPID_SLWPronunciations',
    'SPAUDIOOPTIONS', 'DISPID_SpeechPhraseReplacements', 'SPWORDTYPE',
    'SpeechRecognitionType', 'DISPID_SpeechPhraseElements',
    'SAFT22kHz16BitStereo', 'LONG_PTR', 'SpeechRecoContextState',
    'DISPID_SPIProperties', 'SpeechEngineConfidence', 'SVP_9',
    'SPEI_HYPOTHESIS', 'ISpRecognizer', 'DISPID_SRRSpeakAudio',
    'SpeechEmulationCompareFlags', 'DISPID_SRGSetWordSequenceData',
    'SAFT32kHz16BitMono', 'SpeechTokenShellFolder', 'DISPID_SGRsItem',
    'SpMMAudioIn', 'DISPID_SPEDisplayText',
    'SpeechGrammarTagDictation', 'IEnumSpObjectTokens',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRRTimes',
    'SREPropertyStringChange', 'SRAONone', 'SPBOOKMARKOPTIONS',
    'SP_VISEME_20', 'ISpeechFileStream', 'SpeechRecoEvents',
    'DISPID_SpeechPhraseAlternates', 'ISpeechObjectToken',
    'DISPID_SRCRetainedAudio', 'DISPID_SPPParent', 'SVP_3',
    'SpeechPropertyComplexResponseSpeed', 'SAFT11kHz8BitStereo',
    'SVEBookmark', 'SVP_20', 'SDA_Consume_Leading_Spaces',
    'DISPID_SBSRead', 'DISPID_SpeechPhraseRule', 'SP_VISEME_5',
    'DISPID_SVSpeakStream', 'eLEXTYPE_APP', 'SGSExclusive',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRGCommit', 'SDTRule',
    'DISPID_SASNonBlockingIO', 'SREFalseRecognition',
    'ISpeechAudioBufferInfo', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTDataKey', 'DISPID_SMSALineId', 'SPPS_LMA',
    'SPPS_Noncontent', 'SPFM_CREATE', 'eLEXTYPE_PRIVATE1', 'SVP_14',
    'SAFT8kHz16BitMono', 'SPEI_MIN_SR', 'SPPS_NotOverriden',
    'SAFT24kHz16BitMono', 'DISPID_SPPValue', 'tagSTATSTG',
    'DISPID_SVSLastResult', 'DISPID_SpeechRecognizer',
    'SpeechWordType', 'SpeechSpecialTransitionType',
    'DISPID_SMSAMMHandle', 'SPCT_DICTATION',
    'SpeechAudioFormatGUIDText',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPCLangId',
    'ISpeechPhraseAlternates', 'DISPID_SRRDiscardResultInfo',
    'SPPHRASEREPLACEMENT', 'DISPID_SPRulesCount',
    'SpeechInterference', 'SPAUDIOSTATE', 'SECFEmulateResult',
    'SPSTREAMFORMATTYPE'
]
